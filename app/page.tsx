...
const sources=[
 {slug:'monaco',index:'01',name:'Monaco',kind:'CRM grammar',description:'Dense operational tables, score reasoning and generated-value provenance.',Icon:Table2,tone:'sage'},
